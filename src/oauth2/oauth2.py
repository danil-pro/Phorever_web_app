...
# api_icloud_authorize.add_argument("apple_id", type=str, help="photo_data is required", required=True)
# api_icloud_authorize.add_argument("password", type=str, help="photo_data is required", required=True)
#
#
